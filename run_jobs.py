...
def makejob(commit_id_param, batch_size_param):
    """Makes a new job"""
    return f"""#!/bin/bash

#SBATCH --job-name=cartoongan-fixed-bs-{batch_size_param}
#SBATCH --nodes=1
...
echo "Session " bs_{batch_size_param}_${{SLURM_ARRAY_JOB_ID}}
...
echo "Training"
python3 -m src.run_train --batch-size {batch_size_param}
